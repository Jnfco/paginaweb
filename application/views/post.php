        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block" >
                    ...
                    <button class="btn btn-info" onclick='verPost("<?=$row->id?>")'>Ver post</button>
                </div>
...
function verPost(id) {
    ...
    $.post(base_url+"index.php/Welcome/verPost",{id: id},function(html,data){$("#contenedor").html(html,data); $("#contenedor").show("fast");});
